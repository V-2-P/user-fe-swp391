...
import { Button, List, Empty, Rate, Skeleton, Result } from 'antd'
...
import { useGetProductDetailsQuery } from '~/redux/slices'
...
export const ShoppingCart: React.FC = () => {
  ...
  const { data, isLoading, isFetching, isError } = useGetProductDetailsQuery(Object.keys(cart.items).join(','))
  console.log(data)
    ...
    <div className='px-[10%] p-5 min-h-screen' style={{ background: '#038777' }}>
      <div className='bg-gray-100 p-10'>
        <Skeleton loading={isLoading || isFetching} active>
          {isError ? (
            <Result title='Failed to fetch' subTitle={'Có lỗi gì đó'} status='error' />
