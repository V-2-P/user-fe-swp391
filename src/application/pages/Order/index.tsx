import { Image, List, Skeleton, Tabs, Result, Card, Typography } from 'antd'
...
const OrderPage: React.FC = () => {
  ...
  const orders: Order[] = useMemo(() => {
    if (!loadingOrder && !errorOrder && responseOrder) {
      return responseOrder.data
    }
    return []
  }, [loadingOrder, errorOrder, responseOrder])
  ...
  return (
    <div className=''>
      <Skeleton loading={loadingOrder}>
        {errorOrder ? (
          <Result title='Failed to fetch' subTitle={errorOrder} status='error' />
        ) : (
