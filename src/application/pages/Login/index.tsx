...
const Login: React.FC<HomeProps> = () => {
  return (
    <div className=" min-h-screen  lg:min-h-screen flex lg:justify-center lg:p-8 bg-[url('src/application/assets/images/background.jpg')] bg-[30%] bg-cover bg-no-repeat lg:bg-center">
      ...
      <div className='flex flex-col lg:rounded-xl p-[2%] bg-white bg-opacity-80 shadow-[0_20px_25px_-15px_rgba(0,0,0,0.4)] w-full lg:w-[30%] my-auto'>
        ...
        <div className='w-full text-center space-y-3'>
          <p className='font-bold text-xl lg:text-sm'>Hoặc</p>
          <h1 className='font-bold text-xl lg:text-xl'> Đăng nhập bằng </h1>
          <div className='flex'>
            <div className='w-[50%] flex justify-end mr-4'>
              <Button shape='round' className='!h-fit !rounded-full !w-fit'>
                <svg x='0px' y='0px' width='50' height='70' viewBox='0 0 48 48'>
