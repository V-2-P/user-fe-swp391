...
const Login: React.FC<HomeProps> = () => {
  return (
    <div className=" min-h-screen lg:min-h-0 flex lg:justify-center lg:p-8 bg-[url('src/application/assets/images/background.jpg')] bg-[30%] bg-cover bg-no-repeat lg:bg-center">
